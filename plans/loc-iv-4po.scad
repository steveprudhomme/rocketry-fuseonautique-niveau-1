...
else if(part == "booster") booster();
else if(part == "payload") payload();
else if(part == "nose") nose();
else if(part == "coupler") coupler();
else if(part == "bulkhead") bulkhead();
else if(part == "fin") fin();
else if(part == "motor_mount") tube(mount_od,mount_id,mount_l);
else if(part == "ring") ring();
else if(part == "motor") motor();
else if(part == "retainer" && retention == "MR-1") retainer();
else if(part == "parachute") parachute();
else if(part == "protector") protector();
